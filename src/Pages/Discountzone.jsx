    ...
    return (
     <div className=' mx-auto md:h-[60vh] mt-10 mb-10 md:mb-20'>
       ...
       <div className='  h-3/4  flex  flex-col gap-y-6 md:flex-row justify-around font-bold'>
            ...
            <div className=' mx-auto h-full w-[160px] sm:w-[20%] border-black  bg-green-100 rounded-xl shadow-2xl'>
            ...
            <div className='mx-auto h-full w-[160px] w-[20%] border-black bg-blue-100 rounded-xl shadow-2xl'>
            ...
            <div className='mx-auto  h-full w-[160px] w-[20%] border-black bg-red-100 rounded-xl shadow-2xl'>
